...
00000000004017a8 <getbuf>:
  ...
  4017af:	e8 8c 02 00 00       	call   401a40 <Gets>  # Gets(char *D)获得字符串传入栈顶位置
  4017b4:	b8 01 00 00 00       	mov    $0x1,%eax      # 返回值设为1
  4017b9:	48 83 c4 28          	add    $0x28,%rsp     # Deallocate stack frame
  4017bd:	c3                   	ret    
  4017be:	90                   	nop
  4017bf:	90                   	nop
